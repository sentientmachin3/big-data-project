...
\begin{document}
    ...
    \subsection{Cloudera Docker and system setup}
		...
		\noindent
		The distributed filesystem consists in two basic services: \begin{itemize}
	...
	\subsection{Map Reduce Job}
		...
		\noindent
		Before diving into the implementation of the job, we have to make sure that the current class (compiled into a \verb|jar| file), will run as a hadoop job. In order to do so, we have to add \lstinline|extends Configured implements Tool| to the class declaration.
...
public int compareTo(Object o) {
	...
	\noindent
	The ranking is written in a new file in the HDFS (in directory \lstinline|OUTPUT_PATH|); the first positions are the most similar, the last positions are the smallest affinity pairs.
	...
	\end{itemize}
		...
		\begin{table}[h!]
			\small
			\begin{tabular}{l * {6}{d{1.3}}}
				\toprule
				Author   & \mc{Articles}    & \mc{Conjunctions} & \mc{Pronouns} & \mc{Verbs} & \mc{Prepositions} & \mc{Punctuation} \\
				\midrule
		...
		\begin{table}[h!]
			\small
			\begin{tabular}{l * {3}{d{6.3}}}
				\toprule
				Author   & \mc{Average Period Length} & \mc{Number of Periods} & \mc{Total Number of Words} \\
				\midrule
				J.Abbott      & 23.544 & 2381.489 & 56743.254\\
				C.Dickens     & 23.619 & 5079.822 & 110616.180\\
				R.L.Stevenson & 28.690 & 3544.325 & 85958.46 \\
				\bottomrule
			\end{tabular}
			\caption{Frequencies in known authors' texts}
			\label{tab:known-freqq}
		\end{table}
		...
		\begin{table}[h!]
			...
			\begin{tabular}{l * {6}{d{1.3}}}
				\toprule
				Number & \mc{Articles} & \mc{Conjunctions} & \mc{Pronouns} & \mc{Verbs} & \mc{Prepositions} & \mc{Punctuation} \\
				\midrule
		...
		\begin{table}[h!]
			...
			\begin{tabular}{l * {3}{d{1.3}}}
				\toprule
				Number & \mc{Average Period Length} & \mc{Number of Periods} & \mc{Total Number of Words} \\
				\midrule
				Unknown1 & 19.570 & 2094.0 & 40981.0 \\
				Unknown2 & 27.521 & 2391.0 & 65803.0 \\
				Unknown3 & 26.013 & 2623.0 & 68233.0 \\
				Unknown4 & 18.536 & 2308.0 & 42782.0 \\
				Unknown5 & 19.096 & 4137.0 & 79002.0 \\
				Unknown6 & 20.064 &  883.0 & 17717.0 \\
				\bottomrule
			\end{tabular}
			\caption{Frequencies in unknown authors' texts}
			\label{tab:unknown-freq}
...
\end{figure}
	...
	\begin{figure}[h!]
		...
		We can observe that there is quite a similarity between Abbott frequencies and the unknown authors' texts. The only difference is the use of prepositions in the Unknown3 text, but it is still included in delta intervals.}
