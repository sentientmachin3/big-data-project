...
\end{table}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			...
			\addplot table [x=freq, y=dickens, col sep=comma] {frequencies.csv};
			\addplot table [x=freq, y=melville, col sep=comma] {frequencies.csv};
			\end{axis}
		\end{tikzpicture}
		\caption{frequencies}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			...
			xticklabels={articles,conjunctions,dialogues,commas,prepositions},
			ylabel=Frequencies]
			\addplot table [x=freq, y=abbott, col sep=comma] {abbott-unknown.csv};
			\addplot table [x=freq, y=unknown1, col sep=comma] {abbott-unknown.csv};
			\addplot table [x=freq, y=unknown2, col sep=comma] {abbott-unknown.csv};
			\addplot table [x=freq, y=unknown3, col sep=comma] {abbott-unknown.csv};
			\end{axis}
		\end{tikzpicture}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			\begin{axis}
			[
			legend entries={Unknown4, Unknown5},
			legend style={
				at={(1.5,-0.2)},
				anchor=north,
				legend columns=1,
			...
			ymin=-0.005,
			xtick=data,
			ytick={0.010, 0.015, ..., 0.05},
			legend pos=outer north east,
			yticklabel={\pgfmathprintnumber{\tick}\,\%},
			x tick label style={rotate=90},
			xticklabels={articles,conjunctions,dialogues,commas,prepositions},
			ylabel=Deltas]
			\addplot table [x=freq, y=unknown4, col sep=comma] {deltas-dickens.csv};
			\addplot table [x=freq, y=unknown5, col sep=comma] {deltas-dickens.csv};
			\end{axis}
		\end{tikzpicture}
