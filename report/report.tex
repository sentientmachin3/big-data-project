...
private void exec() {
	...
	During the development process, we tested the program on a bunch of samples (240 files, more or less 97 MB) from 4 different authors: 
	\begin{itemize}
		\item Mary Wollstonecraft Shelley -- 6 texts;
	...
	\end{itemize}
		...
		\begin{table}[h!]
			...
			\begin{tabular}{lcccccc}
				...
				\midrule
				M.Shelley     & 0.075  & 0.059 & 0.130 & 0.051 & 0.131 & 0.066  \\
