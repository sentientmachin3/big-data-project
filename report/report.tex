...
\end{center}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			...
			\addplot[mark=square*, black] table [only marks, x=freq, y=unknown1, col sep=comma] {abbott-unknown.csv};
			\addplot[mark=triangle*, red] table [only marks, x=freq, y=unknown2, col sep=comma] {abbott-unknown.csv};
			\addplot[mark=o] table [only marks, x=freq, y=unknown3, col sep=comma] {abbott-unknown.csv};
			\end{axis}
		\end{tikzpicture}
