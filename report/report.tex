...
\end{table}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			...
			xticklabels={articles,conjunctions,dialogues,commas,prepositions},
			ylabel=Frequencies]
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			...
			xticklabels={articles,conjunctions,dialogues,commas,prepositions},
			ylabel=Frequencies]
			\addplot table [x=freq, y=dickens, col sep=comma] {dickens-unknown.csv};
			\addplot table [x=freq, y=unknown4, col sep=comma] {dickens-unknown.csv};
			\addplot table [x=freq, y=unknown5, col sep=comma] {dickens-unknown.csv};
			\end{axis}
		\end{tikzpicture}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			...
			%\addplot table [mark=none, x=freq, y=dickens, col sep=comma] {deltas-dickens.csv};
			\addplot table [mark=none, x=freq, y=unknown4, col sep=comma] {deltas-dickens.csv};
			\addplot table [mark=none, x=freq, y=unknown5, col sep=comma] {deltas-dickens.csv};
			\addplot+ [
                error bars/.cd,
                    y explicit,
                    y dir=minus,
                ...
                x=freq,
                y=dickens,
                y error plus expr=\thisrow{dickens}-\thisrow{unknown4},
				y error minus expr=\thisrow{dickens}-\thisrow{unknown5},
				col sep=comma
            ] {deltas-dickens.csv};
			%\addplot[ycomb, dashed] plot coordinates{() () () () ()};
			%\addplot[ycomb, dashed] table [x=freq, y expr=\thisrow{dickens}-\thisrow{unknown4}, col sep=comma] {deltas-dickens.csv};
			\end{axis}
		\end{tikzpicture}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			\begin{axis}
			[
			legend entries={Unknown1, Unknown2, Unknown3},
			legend style={
				at={(1.5,-0.2)},
				anchor=north,
				legend columns=1,
			...
			ymin=-0.004,
			xtick=data,
			ytick={0.01, 0.025, ..., 0.2},
			legend pos=outer north east,
			yticklabel={\pgfmathprintnumber{\tick}\,\%},
			x tick label style={rotate=90},
			xticklabels={articles,conjunctions,dialogues,commas,prepositions},
			ylabel=Deltas]
			\addplot table [x=freq, y=unknown1, col sep=comma] {deltas-abbott.csv};
			\addplot table [x=freq, y=unknown2, col sep=comma] {deltas-abbott.csv};
			\addplot table [x=freq, y=unknown3, col sep=comma] {deltas-abbott.csv};
			\end{axis}
		\end{tikzpicture}
	...
	The running time of the whole job is around 7 minutes. The number of mappers is always equal to the number of input texts and there is always an only reducer.
