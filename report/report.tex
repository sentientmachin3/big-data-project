...
private void exec() {
	...
	To do:
	\begin{itemize}
		\item Tabella con dati iniziali per ogni autore noto, frequenze
		\item 1 Grafico per ogni autore con i deltas (similarity)
		\item Grafico per ogni autore mettere le frequenze di articoli, congiunzioni \dots
	\end{itemize}
