	...
	\subsection{Project structure}
		...
		\begin{figure}[h!]
			...
			\dirtree{%
				...
				.3 main. 
				.4 java. 
				.5 analysis \DTcomment{Hadoop output analysis}. 
				.6 frequencies \DTcomment{frequencies calculations}. 
				.7 CommonWord.java. 
				.7 FreqMapEntry.java. 
				.7 FreqMap.java. 
				.6 ranking \DTcomment{authors ranking}. 
				.7 AffinityMap.java. 
				.7 Pair.java. 
				.7 Ranking.java. 
				.7 SimilarityAnalysis.java. 
				.5 hadoop \DTcomment{Hadoop MapReduce implementation}. 
				.6 Authorship.java. 
				.5 Main.java. 
			}}
